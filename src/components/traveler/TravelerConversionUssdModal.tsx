...
import { TravelerConversionUssdSimulator } from "@/components/traveler/TravelerConversionUssdSimulator";
...
export function TravelerConversionUssdModal({
  open,
  onClose,
  onComplete,
}: Props) {
  ...
  return createPortal(
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label="Conversion forfait USSD"
    >
      ...
      >
        <TravelerConversionUssdSimulator
