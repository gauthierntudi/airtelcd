...
import { BusinessSharingUssdSimulator } from "@/components/business/BusinessSharingUssdSimulator";
...
export function BusinessSharingUssdModal({
  open,
  onClose,
  onComplete,
}: Props) {
  ...
  return createPortal(
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label="Partage forfait USSD"
    >
